...
map("x", "<leader>ae", function() require("sidekick.cli").send({ prompt = "explain" }) end, { desc = "Explain Selection" })
map("x", "<leader>ax", function() require("sidekick.cli").send({ prompt = "fix" }) end, { desc = "Fix Selection" })
map("x", "<leader>ar", function() require("sidekick.cli").send({ prompt = "optimize" }) end, { desc = "Optimize Selection" })
